...
6) Install guest additions tools (enables clipboard sharing), then restart VM. (based on: https://linuxize.com/post/how-to-install-virtualbox-guest-additions-in-ubuntu)  
